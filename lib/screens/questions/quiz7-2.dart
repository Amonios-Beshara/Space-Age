...
import 'package:space_age/screens/questions/quiz7-3.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          const Align(
            alignment: Alignment(0.022, -0.57),
            child: SizedBox(
              width: 180.0,
              height: 144.0,
              child: Text(
                'Venus temperature is suitable for life, but life also requires a magnetic field to exist!',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 18,
