...
import 'package:space_age/screens/questions/quiz1-1.dart';
import 'package:space_age/main.dart';
import 'package:space_age/screens/lessons videos/lessonone.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:space_age/screens/questions/quiz2-2.dart';
import 'package:space_age/screens/questions/quiz3-2.dart';
import 'package:space_age/screens/questions/quiz4-2.dart';

class XDQuestiononen22 extends StatefulWidget {
  const XDQuestiononen22({Key? key}) : super(key: key);

  @override
  State<XDQuestiononen22> createState() => _XDQuestiononen22State();
}

class _XDQuestiononen22State extends State<XDQuestiononen22> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Dust in space disappears on exposure to cold weather.',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const XDQuestionon()));
                      },
                      style: ElevatedButton.styleFrom(
                        primary: Colors.red,
                        shape: RoundedRectangleBorder(
