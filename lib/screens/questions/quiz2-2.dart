...
import 'package:space_age/screens/questions/quiz2-3.dart';

class XDQuestiontwo extends StatefulWidget {
  const XDQuestiontwo({Key? key}) : super(key: key);

  @override
  State<XDQuestiontwo> createState() => _XDQuestiontwoState();
}

class _XDQuestiontwoState extends State<XDQuestiontwo> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Parker Solar Probe entered Sun atmosphere.',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const XDQuestionthree()));
                      },
