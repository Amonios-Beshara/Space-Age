...
import 'package:space_age/screens/questions/quiz1-3.dart';

class XDQuestion12 extends StatefulWidget {
  const XDQuestion12({Key? key}) : super(key: key);

  @override
  State<XDQuestion12> createState() => _XDQuestion12State();
}

class _XDQuestion12State extends State<XDQuestion12> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Our sun is 1.5 million Km away from us.',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 20,
