...
class XDQuestionone extends StatefulWidget {
  const XDQuestionone({Key? key}) : super(key: key);

  @override
  State<XDQuestionone> createState() => _XDQuestiononeState();
}

class _XDQuestiononeState extends State<XDQuestionone> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Parker Solar Probe is smart enough to sustain itself.',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 18,
