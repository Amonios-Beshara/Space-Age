...
import 'package:space_age/screens/lessons intro/introfour.dart';
import 'package:space_age/screens/lessons intro/introfive.dart';

class XDQuestiono extends StatefulWidget {
  const XDQuestiono({Key? key}) : super(key: key);

  @override
  State<XDQuestiono> createState() => _XDQuestionoState();
}

class _XDQuestionoState extends State<XDQuestiono> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Space dust comes from the fragments of meteorites and asteroids.',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 18,
