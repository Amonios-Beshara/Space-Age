...
import 'package:space_age/screens/lessons intro/introtwo.dart';

class XDQuestion extends StatefulWidget {
  const XDQuestion({Key? key}) : super(key: key);

  @override
  State<XDQuestion> createState() => _XDQuestionState();
}

class _XDQuestionState extends State<XDQuestion> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Most probes are designed in a way that facilitates their way back to Earth.',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 18,
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const XDPagetwo()));
                      },
                      style: ElevatedButton.styleFrom(
                        primary: Colors.red,
                        shape: RoundedRectangleBorder(
