...
import 'package:space_age/screens/questions/quiz5-2.dart';

class XDQuestiononen extends StatefulWidget {
  const XDQuestiononen({Key? key}) : super(key: key);

  @override
  State<XDQuestiononen> createState() => _XDQuestiononenState();
}

class _XDQuestiononenState extends State<XDQuestiononen> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Corona is the outermost layer of the sun atmosphere. ',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 18,
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const XDQuestion()));
                      },
