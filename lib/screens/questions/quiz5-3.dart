...
import 'package:space_age/screens/lessons intro/introthree.dart';
import 'package:space_age/screens/lessons intro/introsix.dart';

class XDQuestionthree extends StatefulWidget {
  const XDQuestionthree({Key? key}) : super(key: key);

  @override
  State<XDQuestionthree> createState() => _XDQuestionthreeState();
}

class _XDQuestionthreeState extends State<XDQuestionthree> {
  @override
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 144.0,
              child: Text(
                'Sun Core is the hotter thing in the solar system.',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 20,
