...
import 'package:space_age/screens/lessons videos/lessonfive.dart';
import 'package:space_age/screens/lessons videos/lessonsix.dart';
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: const Text(
              'In this chapter, you will learn about a new discovery related to magnetic field and the instrument used during this discovery.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 14,
                color: Color(0xffffffff),
