...
import 'package:space_age/screens/lessons videos/lessontwo.dart';
import 'package:space_age/screens/lessons videos/lessonthree.dart';
import 'package:space_age/screens/lessons videos/lessonfour.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          const Align(
            alignment: Alignment(-0.023, 0.12),
            child: SizedBox(
              width: 400.0,
              height: 60.0,
              child: Text(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 70.0, middle: 0.6806),
            child: const Text(
              'In this chapter, you will learn about the dust in the solar system and how Parker discovered the dust-free zone.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 14,
                color: Color(0xffffffff),
