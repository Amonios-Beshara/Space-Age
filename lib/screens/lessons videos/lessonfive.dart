...
import 'package:space_age/screens/flashcards/cardfive.dart';
import 'package:space_age/screens/questions/quiz5-1.dart';

class XDPagethree extends StatefulWidget {
  const XDPagethree({Key? key}) : super(key: key);

  @override
  State<XDPagethree> createState() => _XDPagethreeState();
}

class _XDPagethreeState extends State<XDPagethree> {
  late VideoPlayerController _controller;
  @override
  void initState() {
    // TODO: implement initState
    _controller = VideoPlayerController.asset('assets/video5.mov')
      ..initialize().then((_) {
        setState(() {});
      });
    super.initState();
