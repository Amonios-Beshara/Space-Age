...
import 'package:space_age/screens/flashcards/cardfour.dart';

class XDPagethree22 extends StatefulWidget {
  const XDPagethree22({Key? key}) : super(key: key);

  @override
  State<XDPagethree22> createState() => _XDPagethree22State();
}

class _XDPagethree22State extends State<XDPagethree22> {
  late VideoPlayerController _controller;
  @override
  void initState() {
    // TODO: implement initState
    _controller = VideoPlayerController.asset('assets/video6.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
    super.initState();
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => const XDPagetwo22()));
                            },
