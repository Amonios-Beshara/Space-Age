...
import 'package:space_age/screens/flashcards/cardseven.dart';
import 'package:space_age/screens/flashcards/cardone.dart';
import 'package:space_age/screens/questions/quiz7-1.dart';

class XDPage3 extends StatefulWidget {
  const XDPage3({Key? key}) : super(key: key);

  @override
  State<XDPage3> createState() => _XDPage3State();
}

class _XDPage3State extends State<XDPage3> {
  late VideoPlayerController _controller;
  @override
  void initState() {
    // TODO: implement initState
    _controller = VideoPlayerController.asset('assets/video7.mov')
      ..initialize().then((_) {
        setState(() {});
      });
    super.initState();
