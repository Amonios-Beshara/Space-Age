...
import 'package:space_age/screens/questions/quiz4-1.dart';

class XDPagetwo22 extends StatelessWidget {
  const XDPagetwo22({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: const Text(
              '[1] Our solar system is filled with dust. \n \n[2] Solar dust comes from fragments of some collision of some celestial bodies, such as comets and meteorites.  \n \n[3] Astronauts predicted previously the presence of a dust-free zone. \n \n[4] Parker’s Probe fulfills the prediction about the dust-free zone. \n \n[5] Parker gave this result by observing the amount of light reflected from the dust.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
                color: Color(0xffffffff),
