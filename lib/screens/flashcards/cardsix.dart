...
import 'package:space_age/screens/questions/quiz6-1.dart';
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: const Text(
              '[1] Parker probe discovers that the magnetic and electric fields switchbacks near the sun. \n \n[2] FIELD instrument used to measure electric and magnetic fields. \n \n[3] FIELD instruments can withstand extreme temperatures. \n \n[4] The most approved assumption that turbulence occurs in the solar wind is the reason.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
                color: Color(0xffffffff),
