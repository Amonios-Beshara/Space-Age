...
import 'package:space_age/screens/questions/quiz7-1.dart';
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 60.0,
              child: Text(
                'Chapter seven: \n What was the purpose of the mission to Venus?',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 15,
          ...
          Pinned.fromPins(
            ...
            child: const Text(
              '[1] Venus gravity aids allowed the Probe to pass by seven times throughout its seven-year mission. \n \n[2] Passing near Venus, the probe was able to catch some extraordinary views of the planet. \n \n[3] Parker Probe could measure Venus atmosphere after 30 years, and it was found that lots of mysterious changes had occurred. \n \n[4] Although Earth and Venus have similar origins, each has developed in completely different ways. \n \n[5] The temperature on Venus is so high that no living being can bear it for some consequent hours.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
                color: Color(0xffffffff),
