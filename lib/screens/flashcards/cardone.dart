        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 60.0,
              child: Text(
                'Chapter one: \n What is the meaning of probe and \n what is the sun? ',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 15,
          ...
          Pinned.fromPins(
            ...
            child: const Text(
              '[1] Our Sun is a 4.5 billion-year-old star. \n \n[2] The Sun is about 150 million kilometers from Earth. \n \n[3] Solar probes are our tools in discovering the harsh out-spaced regions and matters. \n \n[4] Most probes are designed in a way that does not facilitate their way back to Earth.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
                color: Color(0xffffffff),
