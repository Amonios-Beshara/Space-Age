...
class XDPagetwo extends StatelessWidget {
  const XDPagetwo({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: const Text(
              '[1] On August 12, 2018, Parker Solar Probe was launched to investigate the sun. \n \n[2] Parker probe orbital decreases gradually until it is so close to the sun. \n \n[3] Parker Solar Probe was the first spacecraft that reach this distance from the sun, and the only one until now. \n \n[4] Parker Solar Probe entered the suns atmosphere for the first time in history. \n \n[5] Parker Solar Probe is expected to directly impact life and society.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
                color: Color(0xffffffff),
