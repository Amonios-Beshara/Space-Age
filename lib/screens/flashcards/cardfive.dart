...
import 'package:space_age/screens/questions/quiz5-1.dart';
        ...
        children: <Widget>[
          ...
          const Align(
            ...
            child: SizedBox(
              ...
              height: 60.0,
              child: Text(
                'Chapter five: \n Investigating the sun’s corona',
                style: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 15,
          ...
          Pinned.fromPins(
            ...
            child: const Text(
              '[1] Corona is the outermost layer of the sun atmosphere, and it is hotter than the sun surface. \n \n[2] Sun magnetic field is actually bringing energy from inside the sun up through its surface and into its atmosphere.  \n \n[3] Alfvén critical is the boundary of the solar corona. Scientists thought that this boundary is smooth. \n \n[4] When Parker reaches this boundary, it is found that the boundary is irregularly shaped.',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
                color: Color(0xffffffff),
